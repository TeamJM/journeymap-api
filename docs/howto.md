...
`journeymap-api-forge:2.0.0-26.1`
`journeymap-api-neoforge:2.0.0-26.11`
`journeymap-api-fabric:2.0.0-26.1`
`journeymap-api-paper:2.0.0-26.1`

// for multiloader setups, common jar
`journeymap-api-common:2.0.0-26.1`

journeymap_api_version = 2.0.0-26.1
...
with the Minecraft version baked into the version string (e.g. `journeymap-api-paper:2.0.0-26.1`)
