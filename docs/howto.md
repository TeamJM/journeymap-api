...
journeymap_api_version = 1.20-1.9-SNAPSHOT for "1.20 and 1.20.1" or 1.20.2-SNAPSHOT for "1.20.2, 1.20.3, and 1.20.4"
...
* Look in the [example package](https://github.com/TeamJM/journeymap-api/tree/1.20.x_1.9-forge/src/main/java/example/mod) for a complete 
...
1. Write a class that implements the JourneyMap *[journeymap.client.api.IClientPlugin](https://github.com/TeamJM/journeymap-api/tree/1.20.x_1.9-forge/src/main/java/journeymap/client/api/IClientPlugin.java)* interface (like '[ExampleJourneymapPlugin](src/main/java/example/mod/client/plugin/ExampleJourneymapPlugin.java)')
    - Annotate the class with *[@journeymap.client.api.ClientPlugin](https://github.com/TeamJM/journeymap-api/tree/1.20.x_1.9-forge/src/main/java/journeymap/client/api/ClientPlugin.java)* so that JourneyMap can find and instantiate it
