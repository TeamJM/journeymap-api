...
public class FullscreenMapEvent extends ClientEvent
{
    ...
    public static class ClickEvent extends FullscreenMapEvent
    {
         ...
         */
        private ClickEvent(Type type, BlockPos location, RegistryKey<World> level, Point2D.Double mousePosition, int button)
        {
    ...
    public static class MouseDraggedEvent extends FullscreenMapEvent
    {
         ...
         * @param button        - The mouse button.
         */
        private MouseDraggedEvent(Type type, BlockPos location, RegistryKey<World> level, Point2D.Double mousePosition, int button)
        {
            super(type, location, level);
            this.mousePosition = mousePosition;
            this.button = button;
