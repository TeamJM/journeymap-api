 ...
 * @author techbrew
 */
@API(owner = ClientAPIFactory.API_OWNER, apiVersion = ClientAPIFactory.API_VERSION, provides = ClientAPIFactory.API_PROVIDES_IMPL) package journeymap.client.api.impl;
