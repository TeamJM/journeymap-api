...
public interface IClientAPI
{
    ...
    String API_VERSION = "1.6-SNAPSHOT";
     ...
     */
    void requestMapTile(String modId, RegistryKey<World> dimension, Context.MapType mapType, ChunkPos startChunk, ChunkPos endChunk,
