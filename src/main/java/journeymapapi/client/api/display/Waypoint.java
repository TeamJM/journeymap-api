...
import journeymapapi.client.api.model.WaypointBase;
 ...
 * You must call {@link journeymapapi.client.api.IClientAPI#show(Displayable)} in order for the changes to take effect
 * in JourneyMap.
 */
