...
class SampleComplexPolygonOverlayFactory
{
     ...
     * additional helpers.
     */
    public static List<PolygonOverlay> create(IClientAPI jmAPI, BlockPos pos, RegistryKey<World> dimension, int maxDistance)
    {
    ...
    private static List<PolygonOverlay> createOverlays(IClientAPI jmAPI, RegistryKey<World> dimension, String name, String label, List<MapPolygonWithHoles> polygons, TextProperties textProps, ShapeProperties shapeProps)
    {
        final List<PolygonOverlay> result = new ArrayList<>();
