...
package journeymap.api.v2.client.api.impl;
 ...
 */
//@Optional.Interface(iface = "journeymap.client.api.v2.IClientAPI", modid = "journeymap")
@ParametersAreNonnullByDefault
enum MockClientAPI implements IClientAPI
{
    INSTANCE;
