 ...
 *   commit history at the time of import: last touched 2016
 * Modifications: relocated package to journeymap.api.v2.common.util; reformatted
 * to match JourneyMap's Allman brace style. Behavior unchanged from upstream.
 */
...
public class AlphaNumericComparator implements Comparator<String>
{
     ...
     *
     * @param locale   Desired {@code Locale}
     * @param strength Collator strength value, any of: {@link java.text.Collator#PRIMARY},
     ...
     *
     * <p>If either parameter is {@code null} or empty after trim:
     * <ul>
     *   <li>{@code -1} when only the first parameter is null/empty,</li>
     *   <li>{@code  1} when only the second parameter is null/empty,</li>
     *   <li>{@code  0} when both are null/empty.</li>
     * </ul>
     */
    @Override
