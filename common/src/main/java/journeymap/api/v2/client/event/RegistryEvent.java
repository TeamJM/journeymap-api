...
public class RegistryEvent extends ClientEvent
{
    ...
    public static class InfoSlotRegistryEvent extends RegistryEvent
    {
        ...
        {
            registrar.register(modId, new ChatComponentTranslation(key), updateTime, () -> new ChatComponentText(supplier.get()));
        }
         ...
         * Please supply a key.tooltip in your lang files so that the dropdown item has a tool tip.
         * <p>
         * For key please use new ChatComponentTranslation("key") here will also only render as white and does not support param arguments at this time.
         ...
         * @param supplier   - The supplier that gets the value to be displayed.
         */
        public void register(String modId, IChatComponent key, long updateTime, Supplier<IChatComponent> supplier)
        {
        ...
        public interface InfoSlotRegistrar
        {
             ...
             * @param supplier   - The supplier that gets the value to be displayed.
             */
            void register(String modId, IChatComponent component, long updateTime, Supplier<IChatComponent> supplier);
        }
    }
